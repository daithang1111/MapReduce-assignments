...
public class ExtractTopPersonalizedPageRankNodes_VERSION1 extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(ExtractTopPersonalizedPageRankNodes_VERSION1.class);
  ...
  public ExtractTopPersonalizedPageRankNodes_VERSION1() {
  }
  ...
  public int run(String[] args) throws Exception {
    ...
    LOG.info("Tool name: " + ExtractTopPersonalizedPageRankNodes_VERSION1.class.getSimpleName());
 ...
 // get the first source
    ...
    job.setJobName(ExtractTopPersonalizedPageRankNodes_VERSION1.class.getName() + ":" + inputPath);
    job.setJarByClass(ExtractTopPersonalizedPageRankNodes_VERSION1.class);
    ...
    while ((strLine = d.readLine()) != null) {
      ...
      score = StrictMath.exp(Double.parseDouble(tmpStr[1]));
      System.out.println(String.format("%.5f %d", score, nodeId));
    }
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new ExtractTopPersonalizedPageRankNodes_VERSION1(), args);
    System.exit(res);
  }
}
