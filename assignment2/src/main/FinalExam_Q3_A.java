...
public class FinalExam_Q3_A extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(FinalExam_Q3_A.class);
...
//        }
  ...
  public int run(String[] args) throws Exception {
    ...
    LOG.info("Tool name: " + FinalExam_Q3_A.class.getSimpleName());
    LOG.info(" - input path: " + inputPath);
    LOG.info(" - output path: " + outputPath);
    LOG.info(" - num reducers: " + reduceTasks);

    Job job = Job.getInstance(getConf());
    job.setJobName(FinalExam_Q3_A.class.getSimpleName());
    job.setJarByClass(FinalExam_Q3_A.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new FinalExam_Q3_A(), args);
  }
}
